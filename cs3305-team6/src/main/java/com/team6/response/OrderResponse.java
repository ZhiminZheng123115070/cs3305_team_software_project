...
public class OrderResponse {
    ...
    /**
     * Build response from Order entity.
     */
    public static OrderResponse from(Order order) {
        ...
        r.setName(order.getName());
        r.setBrand(order.getBrand());
        r.setImageUrl(order.getImageUrl());
        r.setQuantity(order.getQuantity());
        r.setUnitPrice(order.getUnitPrice());
        r.setLineTotal(order.getLineTotal());
        r.setCurrency(order.getCurrency());
        r.setEnergyKcal(order.getEnergyKcal());
        r.setFat(order.getFat());
        r.setSaturatedFat(order.getSaturatedFat());
        r.setCarbohydrates(order.getCarbohydrates());
        r.setSugars(order.getSugars());
        r.setFiber(order.getFiber());
        r.setProteins(order.getProteins());
        r.setSalt(order.getSalt());
